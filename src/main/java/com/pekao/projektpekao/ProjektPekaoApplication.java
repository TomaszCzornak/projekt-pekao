...
public class ProjektPekaoApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        ...
        public void run (String...args) {
            ...
            ElectronicJournal electronicJournal1 = electronicJournalRepository.save(new ElectronicJournal(new Date(), "Nowa publikacja1", user1, ElectronicJournal.EventType.TO_DO));
            ElectronicJournal electronicJournal2 = electronicJournalRepository.save(new ElectronicJournal(new Date(), "Nowa publikacja2", user1, ElectronicJournal.EventType.WIP));
            ElectronicJournal electronicJournal3 = electronicJournalRepository.save(new ElectronicJournal(new Date(), "Nowa publikacja3", user1, ElectronicJournal.EventType.MANAGER));
